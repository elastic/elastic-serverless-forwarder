...
class StorageFactory:
    ...
    def __init__(self, storage_type: str, **kwargs: any):
        ...
        init_kwargs: list[str] = [key for key in kwargs.keys() if key in self._init_definition_by_storage_type[storage_type]["kwargs"] and kwargs[key]]
