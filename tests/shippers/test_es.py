...
class TestElasticsearchShipper(TestCase):
    ...
    def test_send(self) -> None:
        shipper = ElasticsearchShipper(
            ...
            username="username",
            password="",
            datastream="logs-data.set-namespace",
            tags=["tag1", "tag2", "tag3"],
            batch_max_actions=0,
        )
    ...
    def test_send_with_dataset_discovery(self) -> None:
        ...
        with self.subTest("datastream as `logs-unit-test"):
            shipper = ElasticsearchShipper(
                elasticsearch_url="elasticsearch_url",
                username="username",
                password="password",
                datastream="logs-unit-test",
                tags=["tag1", "tag2", "tag3"],
                batch_max_actions=0,
            )
            es_event = deepcopy(_dummy_event)
        ...
        with self.subTest("datastream not matching logs datastream naming conventation"):
            shipper = ElasticsearchShipper(
                elasticsearch_url="elasticsearch_url",
                username="username",
                password="password",
            ...
            assert shipper._es_index == "datastream"
...
class TestDiscoverDataset(TestCase):
    def test_no_datastream(self) -> None:
        shipper = ElasticsearchShipper(
            ...
            username="username",
            password="password",
            datastream="logs-es-index-no-datastream",
            tags=["tag1", "tag2", "tag3"],
        )
    ...
    def test_custom_dataset(self) -> None:
        shipper = ElasticsearchShipper(
            ...
            username="username",
            password="password",
            datastream="logs-dataset-namespace",
            tags=["tag1", "tag2", "tag3"],
        )
