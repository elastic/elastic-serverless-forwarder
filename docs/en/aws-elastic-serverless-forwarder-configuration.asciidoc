...
Starting from v1.5.0, ESF introduced the SSL fingerprint option to access Elasticsearch clusters using self-signed certificates.
...
YTo set the `ssl_assert_fingerprint` option, you must edit the config file stored in the S3 bucket.
