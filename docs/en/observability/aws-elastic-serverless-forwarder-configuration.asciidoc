...
++++
:keywords: serverless
:description: Learn configuration options for Elastic Serverless Forwarder and how to transform you AWS data as it is collected from Amazon Web Services ({aws}).
