...
// check custom policy i.e. when and by whom
...
* Any typo or misconfiguration in the config file will be ignored (or exceptions raised) and secrets will not be retrieved.
