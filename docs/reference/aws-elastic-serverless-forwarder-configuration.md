...
All regular expressions are case-sensitive and should follow [Python’s 3.12 regular expression syntax](https://docs.python.org/3.12/library/re.html#regular-expression-syntax).
...
No flags are used when the regular expression is compiled. Please refer to [inline flag documentation](https://docs.python.org/3.12/library/re.html#re.compile) for alternative options for multiline, case-insensitive, and other matching behaviors.
...
`inputs.[].multiline.pattern` differs from the patterns supported by {{ls}}. See [Python’s 3.12 regular expression syntax](https://docs.python.org/3.12/library/re.html#regular-expression-syntax) for a list of supported regexp patterns. Depending on how you configure other multiline options, lines that match the specified regular expression are considered either continuations of a previous line or the start of a new multiline event.
