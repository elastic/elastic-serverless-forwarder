...
class ShipperFactory:
    _init_definition_by_target: dict[str, dict[str, any]] = {
        "elasticsearch": {
            ...
            "kwargs":  ["hosts", "scheme", "username", "password", "index"]}
    }
    ...
    def __init__(self, target: str, **kwargs: any):
        ...
        init_kwargs: list[str] = [key for key in kwargs.keys() if key in self._init_definition_by_target[target]["kwargs"] and kwargs[key]]
